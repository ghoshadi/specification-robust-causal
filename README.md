...
The development version of our package `specrobust` can be installed using remotes:

```R
remotes::install_github('ghoshadi/specrobust')
```
...
```R
plot(out, covariates = 'all')
plot(out, covariates = c('X2', 'X3'))
```
